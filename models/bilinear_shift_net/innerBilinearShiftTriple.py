...
from .innerBilinearShiftTripleModule import InnerBilinearShiftTripleModule

class InnerBilinearShiftTriple(nn.Module):
    def __init__(self, fixed_mask, inner_nc, dim, shift_sz=1, stride=1, mask_thred=1, triple_weight=1):
        super(InnerBilinearShiftTriple, self).__init__()
        ...
        self.softShift = InnerBilinearShiftTripleModule(dim, inner_nc, shift_sz, stride)
