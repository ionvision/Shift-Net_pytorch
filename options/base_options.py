...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--which_model_netG', type=str, default='bilinear_unet_shift_triple', help='selects model to use for netG [unet_256| unet_shift_triple| \
                                                                res_unet_shift_triple|soft_unet_shift_triple|patch_soft_unet_shift_triple|res_patch_soft_unet_shift_triple]')
        parser.add_argument('--model', type=str, default='bilinear_shiftnet', \
        ...
        parser.add_argument('--mask_weight', type=float, default=0.0, help='the weight of mask part')
